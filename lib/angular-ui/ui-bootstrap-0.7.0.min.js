...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>bootstrap/ui-bootstrap-0.7.0.min.js at gh-pages · angular-ui/bootstrap · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="18D382A3:41AB:93ECA:52B25A52" name="octolytics-dimension-request_id" />
...
<meta content="Gx52EsF0gSOL8keREWILvwWwaQZTrAwVX0HzbdLJ9Ac=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-75fdcf9e75377bffc3cd84cca9c8b36be54901b4.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="617883a1393041631c86bc6dc12019ac">
        ...
        <link data-pjax-transient rel='permalink' href='/angular-ui/bootstrap/blob/c60f6502b1f48bc714414cfa9fd834986712e64b/ui-bootstrap-0.7.0.min.js'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fangular-ui%2Fbootstrap%2Fblob%2Fgh-pages%2Fui-bootstrap-0.7.0.min.js">Sign in</a>
    </div>
...
<input type="text" data-hotkey="/ s" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" autocapitalize="off"
      ...
      data-sha="dac052a38cb1d0d859dd47f531025c8fbc478dbd"
  >
...
<!-- blob contrib key: blob_contributors:v21:aeee245ea3600bfa80b40ccf9bda9f57 -->
...
<div class="select-menu js-menu-container js-select-menu" >
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/blob/bootstrap3/ui-bootstrap-0.7.0.min.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/blob/bootstrap3_bis2_modalPatch/ui-bootstrap-0.7.0.min.js"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/blob/gh-pages/ui-bootstrap-0.7.0.min.js"
                 data-name="gh-pages"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/blob/master/ui-bootstrap-0.7.0.min.js"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.7.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.7.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.6.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.6.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.5.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.5.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.4.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.4.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.3.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.3.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.2.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.2.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/angular-ui/bootstrap/tree/0.1.0/ui-bootstrap-0.7.0.min.js"
                 data-name="0.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
  ...
  <div class="commit file-history-tease">
    ...
    <time class="js-relative-date" datetime="2013-11-22T12:10:59-08:00" title="2013-11-22 12:10:59">November 22, 2013</time>
    <div class="commit-title">
        <a href="/angular-ui/bootstrap/commit/c60f6502b1f48bc714414cfa9fd834986712e64b" class="message" data-pjax="true" title="chore(release): v0.7.0">chore(release): v0.7.0</a>
    </div>
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/angular-ui/bootstrap/raw/gh-pages/ui-bootstrap-0.7.0.min.js" class="button minibutton " id="raw-url">Raw</a>
            <a href="/angular-ui/bootstrap/blame/gh-pages/ui-bootstrap-0.7.0.min.js" class="button minibutton ">Blame</a>
          <a href="/angular-ui/bootstrap/commits/gh-pages/ui-bootstrap-0.7.0.min.js" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.02204s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
